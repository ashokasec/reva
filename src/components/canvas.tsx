        ...
        if (outerCanvas && innerCanvas) {
            ...
            if (outerContext && innerContext) {
                ...
                outerImage.onload = () => {
                    ...
                    innerImage.src = "https://images.unsplash.com/photo-1469474968028-56623f02e42e?q=80&w=2674&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"; // Replace with the path to your inner image
                    innerImage.onload = () => {
